...
export default function VisionContent() {
  ...
  const { ref: missionCard1Ref, isVisible: missionCard1Visible } = useScrollReveal();
  const { ref: missionCard2Ref, isVisible: missionCard2Visible } = useScrollReveal();
      ...
      <main className="bg-ivory">
        ...
        <section className="relative pt-32 pb-24 overflow-hidden">
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-6 text-center">
            <div
              ref={heroRef}
              className={heroVisible ? "animate-fade-up" : "scroll-hidden"}
            >
        ...
        <section className="py-24 bg-white">
          <div className="max-w-5xl mx-auto px-6">
            <div
              ref={visionRef}
              className={`text-center ${visionVisible ? "animate-fade-up" : "scroll-hidden"}`}
            >
        ...
        <section className="py-24 bg-ivory-dark">
          <div className="max-w-5xl mx-auto px-6">
            <div
              ref={missionRef}
              className={missionVisible ? "animate-fade-up" : "scroll-hidden"}
            >
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div
                  ref={missionCard1Ref}
                  className={`bg-white rounded-3xl p-8 shadow-soft ${missionCard1Visible ? "animate-fade-up" : "scroll-hidden"}`}
                ...
                <div
                  ref={missionCard2Ref}
                  className={`bg-white rounded-3xl p-8 shadow-soft ${missionCard2Visible ? "animate-fade-up" : "scroll-hidden"}`}
        ...
        <section className="py-24 bg-white">
          <div className="max-w-5xl mx-auto px-6">
            <div
              ref={approachRef}
              className={approachVisible ? "animate-fade-up" : "scroll-hidden"}
            >
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-text-primary mb-8 text-center">
                アプローチ（私たちの手法）
              </h2>
              <p className="text-xl md:text-2xl font-bold text-text-primary mb-8 text-center">
                Humanity × Technology
                <br />
                <span className="text-lg font-normal text-text-secondary">（人間味 × 技術）</span>
              </p>
              <p className="text-lg text-text-secondary leading-relaxed mb-12 text-center max-w-3xl mx-auto">
              ...
              <div className="grid md:grid-cols-3 gap-8">
                {[
                  { title: "専門性と親しみやすさ", desc: "高度な技術（Next.jsやHeadless CMS等）を、誰にでもわかる言葉で届けます。", delay: 0.1 },
                  { title: "徹底した「伴走型」", desc: "提案して終わりではなく、成果が出るまで二人三脚で歩みます。", delay: 0.2 },
                  { title: "スモールスタートの推奨", desc: "リスクを最小限に抑え、小さく始めて確実に成功体験を積み上げます。", delay: 0.3 },
                ].map((item) => (
                  <div
                    key={item.title}
                    className={`bg-ivory-dark rounded-3xl p-8 ${approachVisible ? "animate-fade-up" : "scroll-hidden"}`}
                    style={{ animationDelay: `${item.delay}s`, animationFillMode: "both" }}
                  >
        ...
        <section className="py-24 bg-ivory-dark">
          <div className="max-w-5xl mx-auto px-6">
            <div
              ref={valueRef}
              className={valueVisible ? "animate-fade-up" : "scroll-hidden"}
            >
              <h2 className="text-3xl md:text-4xl font-heading font-bold text-text-primary mb-8 text-center">
                バリュー（行動指針）
              </h2>
              ...
              <div className="space-y-8">
                {[
                  { title: "寄り添いマックス", sub: "Empathy First", desc: "お客様の「困った」に誰よりも深く共感し、自分事として考え抜きます。", delay: 0.1 },
                  { title: "分かりやすさマックス", sub: "Simple & Clear", desc: "専門用語を翻訳し、誰もが納得できる透明性の高いコミュニケーションを徹底します。", delay: 0.2 },
                  { title: "挑戦へのハードル最小マックス", sub: "Low Barrier, High Impact", desc: "導入の壁を極限まで低くし、得られる効果を最大化（マックス）させる方法を提案します。", delay: 0.3 },
                ].map((item) => (
                  <div
                    key={item.title}
                    className={`bg-white rounded-3xl p-8 shadow-soft ${valueVisible ? "animate-fade-up" : "scroll-hidden"}`}
                    style={{ animationDelay: `${item.delay}s`, animationFillMode: "both" }}
                  >
        ...
        <section className="py-24 bg-white">
          <div className="max-w-5xl mx-auto px-6">
            <div
              ref={originRef}
              className={`text-center ${originVisible ? "animate-fade-up" : "scroll-hidden"}`}
            >
        ...
        <section className="py-24 bg-ivory-dark">
          <div className="max-w-4xl mx-auto px-6 text-center">
            <div
              ref={ctaRef}
              className={ctaVisible ? "animate-fade-up" : "scroll-hidden"}
            >
